...
/*
 * DEFINES and variables from Kris Winer IMU code
 */
...
void loop() {
  ...
  // Send something every sendTime milliseconds
  if (millis() > prevTime + sendTimer)
  {
    ...
    {
      char textSend1[10] = "";
      sprintf(textSend1, "%04i%04i%01i%01i", yJS, xJS, buttonPress, sendingByte);
      radio.write(&textSend1, sizeof(textSend1));
      Serial.print("Wrote: "); Serial.println(textSend1);
      
      sendingByte = 2;
    }
    else if (sendingByte == 2)
    {
      int yawSend = map((int)yaw, -180, 180, 0, 360);
      int pitchSend = map((int)pitch, -180, 180, 0, 360);
      int rollSend = map((int)roll, -180, 180, 0, 360);
      char textSend2[10] = "";
      sprintf(textSend2, "%03i%03i%03i%01i", yawSend, pitchSend, rollSend, sendingByte);
      radio.write(&textSend2, sizeof(textSend2));
      Serial.print("Wrote: "); Serial.println(textSend2);
  ...
  // Display yaw, pitch, and roll from IMU
  // Display x and y joystick axes
  if (debugging)
  {
    ...
    Serial.print(", ");
    Serial.print(roll, 2);
    Serial.print("\tJoystick X, Joystick Y: ");
    Serial.print(xJS);
    Serial.print(", ");
    Serial.println(yJS);
  }
...
//  MadgwickQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f,  my,  mx, mz);
  ...
  pitch *= 180.0f / PI;
  yaw   *= 180.0f / PI; 
  yaw   += 10.55; // Declination at King George, VA May 8, 2020
  roll  *= 180.0f / PI;
...
//===================================================================================================================
//====== Set of useful functions to access acceleration, gyroscope, magnetometer, and temperature data
//===================================================================================================================
